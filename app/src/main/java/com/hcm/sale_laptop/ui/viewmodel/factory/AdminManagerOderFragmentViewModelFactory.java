...
public class AdminManagerOderFragmentViewModelFactory implements ViewModelProvider.Factory {
    private final Application application;

    public AdminManagerOderFragmentViewModelFactory(Application application) {
