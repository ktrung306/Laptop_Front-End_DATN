...
public class AdminManagerOderFragmentViewModel extends BaseViewModel<LoginRepository> {

    private final MutableLiveData<UserModel> userModel = new MutableLiveData<>();

    public AdminManagerOderFragmentViewModel(@NonNull Application application) {
        super(application);
